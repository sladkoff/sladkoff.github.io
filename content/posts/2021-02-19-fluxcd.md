...
at `ssh://git@github.com/${username}/cluster-name` every `1m0s` using a `flux-system` secret for authentication 
...
- Checkout the configured branch from `ssh://git@github.com/${username}/cluster-name`
